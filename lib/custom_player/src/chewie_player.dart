...
import 'package:next_hour/custom_player/src/player_with_controls.dart';
...
class ChewieController extends ChangeNotifier {
  ...
  Future _initialize() async {
    ...
    if ((autoInitialize || autoPlay) && ! videoPlayerController.value.initialized) { await videoPlayerController.initialize();
    }
