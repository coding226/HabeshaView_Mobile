...
import 'package:next_hour/seekbar/fluttery_seekbar.dart';
import 'package:next_hour/ui/change_password.dart';
...
//  Rounded SeekBar
    ...
    return RadialSeekBar(
      trackColor: primaryDarkColor,
      trackWidth: 8.0,
      progressColor: difference == null ? Colors.red : Color.fromRGBO(255, 165, 0, 1.0),
      progressWidth: 8.0,
...
//  User subscription end date
  ...
  //    This shows subscription end date on manage profile page and also show status of user subscription.
              ...
              Container(
                ...
                child:  status == "1" ? Text(expiryDate == ''? sw : '${DateFormat.yMMMd().format(_date)}', style: TextStyle(color: Colors.white, fontSize: 12.0, ),
                  textAlign: TextAlign.right,) :
                Text( sw, style: TextStyle(color: Colors.white, fontSize: 12.0, ),textAlign: TextAlign.right,),
              )
            ],
          )
        ],
      ...
      return Expanded(
        ...
        child: Container(
          child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text("Joined on", style: TextStyle(color: Colors.white, fontSize: 22.0),textAlign: TextAlign.left,),
                SizedBox(height: 5.0,),
                split[0],
                SizedBox(height: 3.0,),
                split[1]
            ...
            Expanded(
              ...
              child: Container(
                child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text(name, style: TextStyle(color: Colors.white, fontSize: 22.0),textAlign: TextAlign.left,),
                      SizedBox(height: 5.0,),
