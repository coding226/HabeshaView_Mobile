...
import 'package:next_hour/ui/grid_video_page_mt.dart';
import 'package:next_hour/ui/grid_videos_page.dart';
  ...
  Widget allGenresList(){
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index1) {
          ...
          vLiveStatus = searchIds[index]['live'];
