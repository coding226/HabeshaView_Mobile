      ...
      List.generate(homeDataBlocks == null ? 0 : homeDataBlocks.length, (int i){
        return slides.add(
            new Slide(
              ...
              styleTitle:
              TextStyle(color: Color.fromRGBO(255,165,0, 1.0), fontSize: 30.0, fontWeight: FontWeight.bold, fontFamily: 'RobotoMono'),
              description:
...
// Intro slider
    Widget introSlider(){
      return IntroSlider(
        ...
        colorSkipBtn: Color.fromRGBO(255,165,0, 0.3),
        highlightColorSkipBtn: Color.fromRGBO(255,165,0, 1.0),
        ...
        colorDoneBtn: Color.fromRGBO(255,165,0, 0.3),
        highlightColorDoneBtn: Color.fromRGBO(255,165,0, 1.0),

        // Dot indicator
        colorDot: Color.fromRGBO(255,165,0, 1.0),
        sizeDot: 13.0,
