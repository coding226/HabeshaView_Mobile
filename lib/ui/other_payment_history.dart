...
import 'package:next_hour/global.dart' as prefix0;
...
//  Subscription start date and end date
    Widget subscriptionFromTo(i){
      print("${itemList[i].subscriptionTo}");
      return Container(
        child: itemList[i].subscriptionTo != null ? Text(
          'From' +
              ' ' +
...
//    Payment amount
    Widget amount(i){
      print("ef: ${itemList[i].currency.length}");
      if(itemList[i].currency.length == 0){
        return Container(
          child:  Text(
...
//    Row plan name
    Widget planNameRow(i){
      print("Plan ${itemList[i].planName}");
      if(itemList[i].planName.length == 0){
        return Row(
...
//  Scaffold body content
    Widget scaffoldBody(){
      print("UserPaymentType: $userPaymentType");
      return Container(
