        ...
        try {
            ...
            if (widget.item.datatype == "T") {
                for (var j = 0; j < widget.item.seasons.length; j++) {
                    for (var k = 0; k < userWatchList.length; k++) {
                        if(userWatchList[k].season_id == widget.item.seasons[j].id){
                            ...
                            print("wgdyiw: ${response1.statusCode}");
                            userWatchList.removeWhere((item) => item.season_id == widget.item.seasons[j].id);
                        }else{
                            print("oh");
                        }
                    }
                ...
                if (res2['wishlist'] == "1") {
                    ...
                    print('WishList Res: ${response2.statusCode}');
                            ...
                            Container(
                                ...
                                child: Column(
                                    children: <Widget>[
                                        ...
                                        SizedBox(height: 4.0),
                                        Text(
                                            widget.item.released == "null" ? "N/A" : widget.item.released,
                                            style: TextStyle(
                                                color: Colors.white,
                                                fontSize: 12.0,
                                                fontWeight: FontWeight.w800,
