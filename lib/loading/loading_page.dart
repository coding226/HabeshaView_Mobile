    ...
    try {
      ...
      if (accessToken.statusCode == 200) {
        ...
        userWatchListOld = List<VideoDataModel>.generate(
          ...
          print("Genre Id: ${searchIds2[index]['genre_id']}");
          singleId = genreIdbyM.split(",");
//            print(searchIds2[index]['rating']);

          var tmdbrating =  searchIds2[index]['rating'] == null ? 0 : searchIds2[index]['rating'];

          double convrInStart = tmdbrating == null ? 0.0 : tmdbrating / 2;
          print("ratinng: $convrInStart");
          List<dynamic> se2;
          if(type == "T"){
...
//          print("seconfIndex ${showWatchlist[index]}");
  ...
  Widget animatedOpacityLogo(){
      return AnimatedOpacity(
        ...
        child: homeApiResponseData == null ? new Image.asset('assets/logo.png', scale: 1.8,) : new Image.network(
