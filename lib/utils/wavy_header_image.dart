...
class BottomWaveClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    Offset(size.width - (size.width / 4), size.height - 150);
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              colors: [
                // Colors are easy thanks to Flutter's Colors class.
                Color.fromRGBO(255, 165, 0, 0.4).withOpacity(0.4),
                Color.fromRGBO(255, 165, 0, 0.3).withOpacity(0.5),
                Color.fromRGBO(255, 165, 0, 0.2).withOpacity(0.6),
                Color.fromRGBO(255, 165, 0, 0.1).withOpacity(0.7),
              ],
            ),
          ),
          height:200.0,
